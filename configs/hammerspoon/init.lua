...
hs.hotkey.bind({ "cmd", "shift", "alt", "ctrl" }, "y", mountApp("YT Music"))
hs.hotkey.bind({ "cmd", "shift", "alt", "ctrl" }, "p", mountApp("OpenVPN Connect"))
hs.hotkey.bind({ "cmd", "shift", "alt", "ctrl" }, "n", mountApp("Notes"))
